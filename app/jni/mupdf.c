...
#define JNI_FN(A) Java_com_chengzhang_mupdfreader_app ## A //com/chengzhang/mupdfreader/app
#define PACKAGENAME   "com/chengzhang/mupdfreader/app"  //"com/artifex/mupdfdemo"
