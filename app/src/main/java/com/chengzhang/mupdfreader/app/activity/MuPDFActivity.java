package com.chengzhang.mupdfreader.app.activity;
...
import com.chengzhang.mupdfreader.app.*;
import com.chengzhang.mupdfreader.app.constants.OutlineActivityData;
import com.chengzhang.mupdfreader.app.model.MuPDFAlert;
import com.chengzhang.mupdfreader.app.model.OutlineItem;
import com.chengzhang.mupdfreader.app.thread.AsyncTask;
import com.chengzhang.mupdfreader.app.thread.SearchTask;
...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
    ...
    enum TopBarMode {
        Main, Search, Annotation, Delete, More, Accept
    }
    ...
    private final int FILE_PICK_REQUEST = 2;
    ...
    private TextView mAnnotationTypeText;
    private ImageButton mAnnotationButton;
    private ViewAnimator mTopBarSwitcher;
    private ImageButton mLinkButton;
    private MuPDFActivity.TopBarMode mTopBarMode = MuPDFActivity.TopBarMode.Main;
    private MuPDFActivity.AcceptMode mAcceptMode;
        ...
        mDocView = new MuPDFReaderView(this) {
            ...
            protected void onTapMainDocArea() {
                if (!mButtonsVisible) {
                    ...
                    if (mTopBarMode == MuPDFActivity.TopBarMode.Main)
                        hideButtons();
                }
            }
                ...
                switch (mTopBarMode) {
                    case Annotation:
                        if (item == MuPDFView.Hit.Annotation) {
                            showButtons();
                            mTopBarMode = MuPDFActivity.TopBarMode.Delete;
                            mTopBarSwitcher.setDisplayedChild(mTopBarMode.ordinal());
                        }
                        break;
                    case Delete:
                        mTopBarMode = MuPDFActivity.TopBarMode.Annotation;
                        mTopBarSwitcher.setDisplayedChild(mTopBarMode.ordinal());
                        // fall through
                    default:
    ...
    private void reflowModeSet(boolean reflow) {
        ...
        setButtonEnabled(mAnnotationButton, !reflow);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (mTopBarMode == MuPDFActivity.TopBarMode.Search)
    ...
    private void searchModeOn() {
        if (mTopBarMode != MuPDFActivity.TopBarMode.Search) {
            mTopBarMode = MuPDFActivity.TopBarMode.Search;
    ...
    private void makeButtonsView() {
        ...
        mAnnotationButton = (ImageButton) mButtonsView.findViewById(R.id.editAnnotButton);
        mAnnotationTypeText = (TextView) mButtonsView.findViewById(R.id.annotType);
    ...
    public void OnCopyTextButtonClick(View v) {
        ...
        mAnnotationTypeText.setText(getString(R.string.copy_text));
    ...
    public void OnHighlightButtonClick(View v) {
        ...
        mDocView.setMode(MuPDFReaderView.Mode.Selecting);
        mAnnotationTypeText.setText(R.string.highlight);
        showInfo(getString(R.string.select_text));
    }
    ...
    public void OnUnderlineButtonClick(View v) {
        ...
        mDocView.setMode(MuPDFReaderView.Mode.Selecting);
        mAnnotationTypeText.setText(R.string.underline);
        showInfo(getString(R.string.select_text));
    }
    ...
    public void OnStrikeOutButtonClick(View v) {
        ...
        mDocView.setMode(MuPDFReaderView.Mode.Selecting);
        mAnnotationTypeText.setText(R.string.strike_out);
        showInfo(getString(R.string.select_text));
    }
    ...
    public void OnInkButtonClick(View v) {
        ...
        mAnnotationTypeText.setText(R.string.ink);
    ...
    public boolean onSearchRequested() {
        if (mButtonsVisible && mTopBarMode == MuPDFActivity.TopBarMode.Search) {
            hideButtons();
        } else {
            showButtons();
            searchModeOn();
