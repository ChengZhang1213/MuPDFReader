...
public abstract class MuPDFReaderView extends ReaderView {
    protected abstract void onHit(MuPDFView.Hit item);
...
//	protected void onHit(MuPDFView.Hit item) {};
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        if (mMode == Mode.Viewing && !tapDisabled) {
            ...
            MuPDFView.Hit item = pageView.passClickEvent(e.getX(), e.getY());
            onHit(item);
            if (item == MuPDFView.Hit.Nothing) {
