...
import com.chengzhang.mupdfreader.app.utils.Bezier;
import com.chengzhang.mupdfreader.app.utils.ControlTimedPoints;
import com.chengzhang.mupdfreader.app.utils.TimedPoint;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        //Configurable parameters
        try {
            mMinWidth = a.getFloat(R.styleable.SignatureView_minWidth, 3f);
            mMaxWidth = a.getFloat(R.styleable.SignatureView_maxWidth, 7f);
    ...
    public void setPenColorRes(int colorRes) {
        try {
            ...
            setPenColor(getResources().getColor(R.color.pen_Black));
        }
    }
