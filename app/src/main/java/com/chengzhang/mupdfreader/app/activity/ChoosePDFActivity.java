...
import com.chengzhang.mupdfreader.app.constants.Purpose;
import com.chengzhang.mupdfreader.app.model.ChoosePDFItem;
import com.chengzhang.mupdfreader.app.ui.ChoosePDFAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUpdateFiles = new Runnable() {
            public void run() {
                ...
                adapter.clear();
                if (mParent != null)
                    adapter.add(new ChoosePDFItem(ChooseType.PARENT, getString(R.string.parent_directory)));
                for (File f : mDirs)
                    adapter.add(new ChoosePDFItem(ChooseType.DIR, f.getName()));
                for (File f : mFiles)
                    adapter.add(new ChoosePDFItem(ChooseType.DOC, f.getName()));
